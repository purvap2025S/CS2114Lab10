...
public class DLList<E> implements Iterable<E> {
    ...
    private class DLListIterator implements Iterator<E> {
        ...
        /**
         * Initializes the iterator to start at the first element.
         */
        public DLListIterator() {
            next = head.next(); // Start from first element (skip sentinel)
        }
        ...
        public boolean hasNext() {
            return next != tail; // Sentinel tail marks end of list
        }
